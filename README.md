...
> "При написании конфигурации постарадал один 17-летний лысый ребенок" — **septumman** [cite: 1]
...
* **Иконки:** `Papirus-Dark` [cite: 3]
* **Курсор:** `Adwaita` [cite: 3]
* **Тема:** `Adwaita-dark` [cite: 3]
