# 🛸 Silver Metal Sway Dotfiles
> [cite_start]"При написании конфигурации постарадал один 17-летний лысый ребенок" — **septumman** [cite: 1]
...
[cite_start]Для полной работоспособности установлены следующие пакеты:
...
* [cite_start]**Иконки:** `Papirus-Dark` [cite: 3]
* [cite_start]**Курсор:** `Adwaita` [cite: 3]
* [cite_start]**Тема:** `Adwaita-dark` [cite: 3]
...
[cite_start]*Модификатор `$mod` = **Win*** [cite: 1]

### [cite_start]Запуск приложений [cite: 7, 8, 9]
...
### [cite_start]Управление окнами [cite: 5, 6, 7]
* `$mod + Q` — Закрыть окно
* `$mod + F` — Полный экран
...
### [cite_start]Система [cite: 10, 12, 13]
...
[cite_start]Конфиг поставляется с универсальным установщиком для **Arch**, **Fedora** и **Debian**.
